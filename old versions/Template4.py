...
class MainMenu(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.add_slice = customtkinter.CTkButton(master, text_color="white", fg_color="#7986CB", bg_color="transparent", text="+", font=("Trebuchet MS", 30), anchor="center", command=exit)
        self.add_slice.grid(column=2, columnspan=2, row=15, rowspan=7, sticky="news")
        
        self.remove_slice = customtkinter.CTkButton(master, text_color="white", fg_color="#7986CB", bg_color="transparent", text="-", font=("Trebuchet MS", 30), anchor="center", command=exit)
        self.remove_slice.grid(column=5, columnspan=2, row=15, rowspan=7, sticky="news")
        ...
        self.start = customtkinter.CTkButton(master, image=images[4], text="", anchor="center", command=exit)
        self.start.grid(column=9, columnspan=8, row=6, rowspan=15, sticky="news")

        self.leave = customtkinter.CTkButton(master, image=images[5], text="", anchor="center", command=exit)
