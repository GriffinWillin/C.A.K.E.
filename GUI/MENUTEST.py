...
class MainMenu(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        images = ["C.A.K.E_", "Ellipse 1", "R", "slices", "Start", "Stop"]

        for i in range(len(images)):
            image = Image.open(os.path.join("Images", f"{images[i]}.png"))
            image_i = customtkinter.CTkImage(image, size=(100,100))

        self.splash = customtkinter.CTkLabel(master, text="retard.", text_color="white", bg_color="#90CAF9", anchor='center', fg_color="transparent", font=("Yu Mincho Demibold", 100))
        self.splash.grid(column=0, columnspan=4, row=0, rowspan=2)

        self.diagram = customtkinter.CTkLabel(master, text="diagram", text_color="white", bg_color="#90CAF9", anchor='center', fg_color="transparent", font=("Yu Mincho Demibold", 100))
        self.diagram.grid(column=1, columnspan=5, row=3, rowspan=4)
        ...
        self.add_slice.grid(column=1, columnspan=2, row=3, rowspan=2, sticky="news")
        ...
        self.remove_slice.grid(column=4, columnspan=2, row=3, rowspan=2, sticky="news")
        
        self.slice_num = customtkinter.CTkButton(master, text_color="white", fg_color="#655482", bg_color="transparent", text="slices", font=("Trebuchet MS", 30), anchor="center", command=exit)
        ...
        self.themes.grid(column=15, columnspan=2, row=0, sticky="news")
        ...
        self.options.grid(column=18, columnspan=2, row=0, sticky="news")

        self.start = customtkinter.CTkButton(master, text_color="white", fg_color="#655482", text="EXIT", font=("Trebuchet MS", 30), anchor="center", command=exit)
        self.start.grid(column=3, columnspan=2, row=9, sticky="news")
