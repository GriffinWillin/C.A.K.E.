...
class MainMenu(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.splash.place(x=self.winfo_screenwidth()//2+120, y=self.winfo_screenheight()//3, anchor="center")
        ...
        self.add_slice = customtkinter.CTkButton(master, text_color="white", fg_color="blue", bg_color="transparent", text="+", font=("Trebuchet MS", 30), anchor="center", command=exit)
        self.add_slice.grid(column=2, columnspan=2, row=15, rowspan=7, sticky="news")
        
        self.remove_slice = customtkinter.CTkButton(master, text_color="white", fg_color="blue", bg_color="transparent", text="-", font=("Trebuchet MS", 30), anchor="center", command=exit)
        ...
        self.start = customtkinter.CTkButton(master, text_color="white", fg_color="green", text=" START", font=("Trebuchet MS", 100), anchor="center", command=exit)
        self.start.grid(column=9, columnspan=8, row=6, rowspan=15, sticky="news")

        self.leave = customtkinter.CTkButton(master, text_color="white", fg_color="red", text=" EXIT", font=("Trebuchet MS", 100), anchor="center", command=exit)
